...
.then(data => {
  console.log("rendering team_stats");
...
.then(data => {
  res.render('pages/player_info',{
      ...
      pID: player_id,
      query1: data[0], //all football_player objects
      query2: data[1][0], //football player info based on player_id input
      query3: data[2][0]['count']  //number of football games the player has played
    })
})
.catch(error => {
    // display error message in case an error
